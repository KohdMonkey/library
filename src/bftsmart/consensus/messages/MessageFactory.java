...
public class MessageFactory{
    ...
    public static final int EXECUTE = 44784;
    ...
    public ConsensusMessage createExecute(int id, int epoch, byte[] value) {

        return new ConsensusMessage(EXECUTE,id,epoch, from, value);
