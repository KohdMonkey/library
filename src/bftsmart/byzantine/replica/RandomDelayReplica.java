 ...
 */
public class RandomDelayReplica extends ServiceReplica {
     ...
     */
    public RandomDelayReplica(int id, Executable executor, Recoverable recoverer) {
     ...
     */
    public RandomDelayReplica(int id, Executable executor, Recoverable recoverer, RequestVerifier verifier) {
     ...
     * @see bellow
     */
    public RandomDelayReplica(int id, Executable executor, Recoverable recoverer, RequestVerifier verifier, Replier replier) {
     ...
     * @see bellow
     */
    public RandomDelayReplica(int id, Executable executor, Recoverable recoverer, RequestVerifier verifier, Replier replier, KeyLoader loader, Provider provider) {
     ...
     */
    public RandomDelayReplica(int id, String configHome, Executable executor, Recoverable recoverer, RequestVerifier verifier, Replier replier, KeyLoader loader) {
        this.id = id;
            ...
            for (TOMMessage request : requestsFromConsensus) {
                ...
                if (request.getViewID() == SVController.getCurrentViewId()) {
                    ...
                    tomLayer.getCommunication().send(new int[]{request.getSender()}, new TOMMessage(SVController.getStaticConf().getProcessId(),
                            request.getSession(), request.getSequence(), request.getOperationId(), TOMUtil.getBytes(SVController.getCurrentView()),
                            SVController.getCurrentViewId(), request.getReqType(), request.isSpeculative()));
                }
                requestCount++;
            }
    ...
    private void initTOMLayer() {
        ...
        RandomDelayAcceptor acceptor = new RandomDelayAcceptor(cs, messageFactory, SVController);
